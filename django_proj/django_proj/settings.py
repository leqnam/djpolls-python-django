...
SECRET_KEY = '_7rx5=7=zf4_ph$mr2)vivik&mi)@q2&hty*7wu10*&a#^fm2s'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True, # Enable the template source files inside installed applications. Default is False
        'OPTIONS': {
            'context_processors': [
...
# DATABASE_ROUTERS = (
#     'django_proj.database_router.DatabaseRouter',
# )
